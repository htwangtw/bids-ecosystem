...
.center[
  ...
  ![:img ReproIn conversion schema, 40%](assets/dbic-conversions_cropped.png)
...
BIDS specifies the [Inheritance Principle](https://bids-specification.readthedocs.io/en/v1.10.0/common-principles.html#the-inheritance-principle):
...
layout = BIDSLayout(
    '/data/bids/openneuro/ds000228-fmriprep',
...
[being extended](https://bids-specification.readthedocs.io/en/stable/derivatives/introduction.html)
...
#### Dataset-level metadata is stored in augmented [`dataset_description.json`](https://bids-specification.readthedocs.io/en/stable/modality-agnostic-files.html#derived-dataset-and-pipeline-description):
...
#### Additional metadata in [sidecar JSON files](https://bids-specification.readthedocs.io/en/stable/derivatives/common-data-types.html)
